...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (preRegistrationHandler) {
<span class="cstat-no" title="statement not covered" >      return preRegistrationHandler(formData, req, res, callback);</span>
    }
&nbsp;
    callback();
  }
...
<span class="cstat-no" title="statement not covered" >      return postRegistrationHandler(account, req, res, responseHandler.bind(null, req, res));</span>
    }
&nbsp;
...
&nbsp;
                  <span class="missing-if-branch" title="if path not taken" >I</span>if (config.web.register.emailVerificationRequired) {
<span class="cstat-no" title="statement not covered" >                    options.activate = false;</span>
                  }
&nbsp;
                  client.createUser(oktaUser, options, function (err, account) {
&nbsp;
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >                      return helpers.writeJsonError(res, oktaErrorTransformer(err));</span>
                    }
&nbsp;
...
&nbsp;
                      <span class="missing-if-branch" title="if path not taken" >I</span>if (config.web.register.emailVerificationRequired) {
<span class="cstat-no" title="statement not covered" >                        emailVerificationHandler(account);</span>
                      }
&nbsp;
                      <span class="missing-if-branch" title="if path not taken" >I</span>if (config.web.register.autoLogin) {
<span class="cstat-no" title="statement not covered" >                        var options = {</span>
                          username: req.body.email,
                          password: req.body.password
                        };
&nbsp;
<span class="cstat-no" title="statement not covered" >                        return helpers.authenticate(options, req, res, <span class="fstat-no" title="function not covered" >function (err, account, authResult) {</span></span>
<span class="cstat-no" title="statement not covered" >                          if (err) {</span>
<span class="cstat-no" title="statement not covered" >                            return helpers.writeJsonError(res, err);</span>
                          }
&nbsp;
<span class="cstat-no" title="statement not covered" >                          helpers.createSession(authResult, account, req, res);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                          handleResponse(account, defaultJsonResponse);</span>
                        });
                      }
&nbsp;
                      req.user = account;
...
&nbsp;
        return helpers.organizationResolutionGuard(req, res, formActionUri, function () {
          switch (req.method) {
            ...
            case 'GET':
&nbsp;
              <span class="missing-if-branch" title="if path not taken" >I</span>if (helpers.requiresOrganizationResolution(req)) {
<span class="cstat-no" title="statement not covered" >                return helpers.parentDomainRedirect(req, res);</span>
              }
&nbsp;
...
&nbsp;
                ...
                function (callback) {
                  helpers.prepAccountData(req.body, config, function (accountData) {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (req.organization) {
<span class="cstat-no" title="statement not covered" >                      accountData.accountStore = {</span>
