...
<span class="cstat-no" title="statement not covered" >            options.accountStore = {</span>
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (account) {
<span class="cstat-no" title="statement not covered" >              emailVerificationHandler(new Account(account));</span>
            }
&nbsp;
            res.end();
          });
...
&nbsp;
            application.resendVerificationEmail(options, function (err, account) {
              ...
              <span class="missing-if-branch" title="if path not taken" >I</span>if (err &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >err.code !== 2016)</span> {
