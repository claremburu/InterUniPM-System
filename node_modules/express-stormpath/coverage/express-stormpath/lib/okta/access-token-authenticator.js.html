...
<html lang="en">
<head>
    <title>Code coverage report for express-stormpath/lib/okta/access-token-authenticator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">express-stormpath/lib/okta/</a> access-token-authenticator.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">78.57% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>33/42</span>
      </div>
      <div class='fl pad1y space-right2'>
...
function AccessTokenAuthenticator(client) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof AccessTokenAuthenticator)) {
<span class="cstat-no" title="statement not covered" >    return new AccessTokenAuthenticator();</span>
  }
  this.client = client;
...
&nbsp;
AccessTokenAuthenticator.prototype.forOrg = <span class="fstat-no" title="function not covered" >function forOrg(org) {</span>
<span class="cstat-no" title="statement not covered" >  this.org = org;</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
AccessTokenAuthenticator.prototype.withClientId = <span class="fstat-no" title="function not covered" >function withClientId(clientId) {</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (self.localValidation) {
...
<span class="cstat-no" title="statement not covered" >      return callback(err);</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!res.keys || !res.keys.length) {
<span class="cstat-no" title="statement not covered" >      return callback('Keys collection not found');</span>
    }
&nbsp;
    var matches = res.keys.filter((key) =&gt; key.kid === kid);
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (matches.length === 0) {
<span class="cstat-no" title="statement not covered" >      return callback('Unresolved signing key');</span>
    }
&nbsp;
