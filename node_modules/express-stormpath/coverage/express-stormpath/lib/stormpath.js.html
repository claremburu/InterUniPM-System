  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>101/123</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!logger) {
...
&nbsp;
  client.on('error', <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >    logger.error(err);</span>
<span class="cstat-no" title="statement not covered" >    app.emit('stormpath.error', err);</span>
  });
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (config.expand &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >config.expand.customData !== false)</span> {
<span class="cstat-no" title="statement not covered" >      config.expand.customData = true;</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (web.multiTenancy.enabled) {
<span class="cstat-no" title="statement not covered" >      var organizationResolver = middleware.defaultOrganizationResolver;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (web.multiTenancy.organizationResolver) {</span>
<span class="cstat-no" title="statement not covered" >        organizationResolver = web.multiTenancy.organizationResolver;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      router.use(organizationResolver);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (web.idSite.enabled) {
<span class="cstat-no" title="statement not covered" >      addGetRoute(web.idSite.uri, controllers.idSiteVerify);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (web.register.enabled) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (web.idSite.enabled) {
<span class="cstat-no" title="statement not covered" >        addGetRoute(web.register.uri, controllers.idSiteRedirect({ path: web.idSite.registerUri }));</span>
      } else {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (web.login.enabled) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (web.idSite.enabled) {
<span class="cstat-no" title="statement not covered" >        addGetRoute(web.login.uri, controllers.idSiteRedirect({ path: web.idSite.loginUri }));</span>
      } else {
...
<span class="cstat-no" title="statement not covered" >      var provider = config.web.social[providerName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (provider.enabled) {</span>
<span class="cstat-no" title="statement not covered" >        addGetRoute(provider.uri, controllers.idpLogin.bind(null, provider));</span>
      }
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (web.forgotPassword.enabled) {
<span class="cstat-no" title="statement not covered" >      if (web.idSite.enabled) {</span>
<span class="cstat-no" title="statement not covered" >        addGetRoute(web.forgotPassword.uri, controllers.idSiteRedirect({ path: web.idSite.forgotUri }));</span>
      } else {
<span class="cstat-no" title="statement not covered" >        addGetRoute(web.forgotPassword.uri, controllers.forgotPassword);</span>
<span class="cstat-no" title="statement not covered" >        addPostRoute(web.forgotPassword.uri, controllers.forgotPassword);</span>
      }
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (web.changePassword.enabled) {
<span class="cstat-no" title="statement not covered" >      addGetRoute(web.changePassword.uri, controllers.changePassword);</span>
<span class="cstat-no" title="statement not covered" >      addPostRoute(web.changePassword.uri, controllers.changePassword);</span>
    }
&nbsp;
 ...
 */
module.exports.groupsRequired = <span class="fstat-no" title="function not covered" >function groupsRequiredProxy() {</span>
<span class="cstat-no" title="statement not covered" >  return getUserMiddlewareProxy(middleware.groupsRequired.apply(null, arguments));</span>
};
&nbsp;
/**
