...
&nbsp;
  function continueWithAuthentication() {
    var oauthRequest = options || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (config.postLoginHandler) {
<span class="cstat-no" title="statement not covered" >            return config.postLoginHandler(user, req, res, <span class="fstat-no" title="function not covered" >function (err) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >              callback(null, user, oauthAccessTokenResult);</span>
            });
          }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (config.preLoginHandler) {
<span class="cstat-no" title="statement not covered" >    return config.preLoginHandler(options, req, res, <span class="fstat-no" title="function not covered" >function (err) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        logger.info('Error when trying to execute the preLoginHandler before authenticating the user.');</span>
<span class="cstat-no" title="statement not covered" >        return callback(err);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      continueWithAuthentication();</span>
    });
  }
&nbsp;
