...
module.exports = function getHost(req, stripPort) {
  ...
  var host = req.app.get('trust proxy') ? (<span class="branch-0 cbranch-no" title="branch not covered" >xForwardedHostHeader || hostHeader)</span> : hostHeader;
&nbsp;
  if (stripPort) {
    host = host.match(/:/g) ? host.slice(0, host.indexOf(':')) : <span class="branch-1 cbranch-no" title="branch not covered" >host;</span>
  }
&nbsp;
  return host;
};</pre></td></tr>
