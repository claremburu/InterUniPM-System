...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (authenticationResult.access_token) {
    setTokenCookie(authenticationResult.access_token, stormpathConfig.web.accessTokenCookie);
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (authenticationResult.refresh_token) {
